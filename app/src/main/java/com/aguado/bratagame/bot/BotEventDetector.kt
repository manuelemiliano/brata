    ...
    private fun detectarCambiosEnPartida(
        ...
        salaNueva.jugadores.forEach { (jugadorId, jugadorNuevo) ->
            ...
            for (pos in 0..3) {
                ...
                when {
                    // Ocupada → vacía: la carta se fue de esa posición
                    !antVacia && nvoVacio -> {
                        eventos.add(
                    ...
                    // Vacía → ocupada: alguien puso una carta en una posición vacía
                    antVacia && !nvoVacio -> {
                        eventos.add(
                    ...
                    // Ocupada → ocupada con id distinto: hubo cambio en esa posición
